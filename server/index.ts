...
console.log("[server] Imports completed successfully");
...
app.use(cors({
  origin: true, // Allow all origins for development ease, or specify array
  credentials: true
}));
...
(async () => {
  ...
  // `reusePort` is not supported on Windows (will throw ENOTSUP). Only enable on non-Windows.
